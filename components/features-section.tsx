...
export function FeaturesSection() {
  return (
    <section id="features" className="relative py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-8 text-balance text-black">
          Everything You Get
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          <div className="rounded-2xl p-8 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all duration-300 group bg-white">
          ...
          <div className="rounded-2xl p-8 border border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all duration-300 group bg-white">
            <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
              <CheckCircle className="w-7 h-7 text-blue-600 group-hover:text-white" />
            </div>
            <h3 className="text-lg font-bold mb-3 text-black">
              Human Handoff
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-16">
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-8">
            <div className="text-5xl md:text-6xl font-bold text-blue-600 mb-2">500+</div>
            <div className="text-gray-700 font-medium">Agencies & Businesses</div>
          </div>
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-8">
            <div className="text-5xl md:text-6xl font-bold text-blue-600 mb-2">50K+</div>
            <div className="text-gray-700 font-medium">Qualified Leads Generated</div>
          </div>
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-8">
            <div className="text-5xl md:text-6xl font-bold text-blue-600 mb-2">$10M+</div>
            <div className="text-gray-700 font-medium">Revenue Helped Generate</div>
          </div>
        </div>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-block px-10 py-4 bg-blue-600 text-white font-bold text-lg rounded-lg hover:bg-blue-700 transition-colors cursor-pointer"
          >
